...
public class StatementForCondFact extends Statement {
    ...
    public StatementForCondFact (ForSt ForSt, DesignatorStatementList DesignatorStatementList, LSemiFor LSemiFor, CondFactFor CondFactFor, RSemiFor RSemiFor, DesignatorStatementListSecond DesignatorStatementListSecond, RParenFor RParenFor, Statement Statement) {
        this.ForSt=ForSt;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("StatementForCondFact(\n");
