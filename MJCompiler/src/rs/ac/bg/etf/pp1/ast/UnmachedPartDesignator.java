...
public class UnmachedPartDesignator extends UnmachedList {

    private UnmachedList UnmachedList;
    private Designator Designator;

    public UnmachedPartDesignator (UnmachedList UnmachedList, Designator Designator) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("UnmachedPartDesignator(\n");
